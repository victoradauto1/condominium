...
contract CondominiumAdapter {
    ...
    function getResidents(uint page, uint pageSize) external view upgraded returns(Lib.ResidentsPage memory){
    ...
    function getTopics(uint page, uint pageSize) external view upgraded returns(Lib.TopicsPage memory){
